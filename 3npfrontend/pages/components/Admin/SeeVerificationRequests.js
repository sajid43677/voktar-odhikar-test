...
export default function SeeVerificationRequests() {
    const headerColumns = ["", "License Number", "Uid", ""];
  ...
  const fetchPro = async () => {
    try {
      const res = await axios.get(
        process.env.NEXT_PUBLIC_API_End + "admin/approveverificationforindustryanddistributor/",
